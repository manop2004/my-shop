...
export default function ShopPage() {
  ...
  <div className="max-w-[1300px] mx-auto px-6 h-[70px] flex items-center justify-between">
    ...
    <button 
      ...
      className="text-gray-800 hover:text-[#C5A059] transition-colors"
    >
    ...
    {/* CENTER */}
    <h1 className="text-xl md:text-2xl font-serif font-semibold tracking-[0.25em] text-[#C5A059] text-center whitespace-nowrap">
      MUSEUM SHOP
    </h1>
