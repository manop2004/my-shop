    ...
    <div className="bg-[#fdfbf7] min-h-screen font-sans text-gray-800 relative overflow-x-hidden">
      ...
      {/* NAVBAR */}
        <nav className="bg-white border-b border-[#e8dcc4] sticky top-0 z-50 shadow-sm">
          <div className="max-w-[1300px] mx-auto px-6 h-[70px] relative flex items-center">

            {/* LEFT MENU BUTTON */}
            <button 
              onClick={() => setIsSidebarOpen(true)} 
              className="absolute left-6 text-gray-800 hover:text-[#C5A059] transition-colors"
            >
            ...
            {/* CENTER TITLE */}
            <h1 className="mx-auto text-xl md:text-2xl font-serif font-semibold tracking-[0.25em] text-[#C5A059] drop-shadow-sm">
              MUSEUM SHOP
            </h1>
            ...
            <div className="absolute right-6 flex items-center gap-6">
              ...
              <button onClick={handleOpenCart} className="relative hover:text-[#C5A059] transition-colors text-gray-800">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
